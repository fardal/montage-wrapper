...
def mAdd(images_table, template_header, out_image, img_dir=None,
          ...
          status_file=None, mpi=False, n_proc=8, verbose=False):
    '''
...
def mArchiveExec(region_table, debug_level=None, verbose=False):
    '''
...
def mArchiveGet(remote_ref, local_file, debug=False, raw=False, verbose=False):
    '''
...
def mArchiveList(survey, band, object_or_location, width, height, out_file, verbose=False):
    '''
...
def mBackground(in_image, out_image, A, B, C, debug_level=None, no_area=False,
          status_file=None, verbose=False):
    '''
...
def mBackground_tab(in_image, out_image, images_table, corrections_table,
          debug_level=None, no_area=False, status_file=None, verbose=False):
    '''
    Remove a background plane from a FITS image.  The background correction
    applied to the image is specified as Ax+By+C, where (x,y) is the pixel
    coordinate using the image center as the origin, and (A,B,C) are the
...
def mBestImage(images_table, ra, dec, debug=False, verbose=False):
    '''
...
def mBgExec(images_table, corrections_table, corr_dir, proj_dir=None,
          status_file=None, debug=False, no_area=False, mpi=False, n_proc=8, verbose=False):
    '''
...
def mBgModel(images_table, fits_table, corrections_table, n_iter=None,
          level_only=False, debug_level=None, ref_img=None, status_file=None, verbose=False):
    '''
...
def mCatMap(in_table, out_image, template_header, column=None, ref_mag=None,
          debug_level=None, size=None, verbose=False):
    '''
...
def mConvert(in_image, out_image, debug_level=None, status_file=None,
          bitpix=None, min_val=None, max_val=None, blank_value=None, verbose=False):
    '''
...
def mDiffExec(diffs_table, template_header, diff_dir, proj_dir=None,
          debug=False, no_area=False, status_file=None, mpi=False, n_proc=8, verbose=False):
    '''
...
def mExec(survey, band, raw_dir=None, n_tile_x=None, n_tile_y=None,
          ...
          workspace_dir=None, verbose=False):
    '''
...
def mFitExec(diffs_table, fits_table, diff_dir, debug=False, status_file=None,
          mpi=False, n_proc=8, verbose=False):
    '''
...
def mFitplane(in_image, border=None, debug_level=None, status_file=None, verbose=False):
    '''
...
def mFixNaN(in_image, out_image, debug_level=None, nan_value=None,
          min_blank=None, max_blank=None, verbose=False):
    '''
...
def mFlattenExec(images_table, flat_dir, img_dir=None, debug=False,
          no_area=False, status_file=None, verbose=False):
    '''
...
def mGetHdr(in_image, img_header, debug=False, hdu=None, status_file=None, verbose=False):
    '''
...
def mHdr(object_or_location, width, out_file, system=None, equinox=None,
          height=None, pix_size=None, rotation=None, verbose=False):
    '''
...
def mHdrCheck(in_image, status_file=None, verbose=False):
    '''
...
def mHdrtbl(directory, images_table, recursive=False, corners=False,
          debug=False, output_invalid=False, status_file=None, img_list=None, verbose=False):
    '''
...
def mImgtbl(directory, images_table, recursive=False, corners=False,
          ...
          status_file=None, fieldlist=None, img_list=None, verbose=False):
    '''
...
def mPix2Coord(template_header, ixpix, jypix, debug=False, verbose=False):
    '''
...
def mProject(in_image, out_image, template_header, factor=None,
          ...
          weight_file=None, threshold=None, whole=False, verbose=False):
    '''
...
def mProjectPP(in_image, out_image, template_header, factor=None,
          ...
          threshold=None, whole=False, verbose=False):
    '''
...
def mPutHdr(in_image, out_image, template_header, debug=False,
          status_file=None, hdu=None, verbose=False):
    '''
...
def mRotate(in_image, out_image, debug_level=None, status_file=None,
          rotation_angle=None, ra=None, dec=None, xsize=None, ysize=None, verbose=False):
    '''
...
def mSubimage(in_image, out_image, ra, dec, xsize, debug=False,
          all_pixels=False, hdu=None, status_file=None, ysize=None, verbose=False):
    '''
...
def mSubimage_pix(in_image, out_image, xstartpix, ystartpix, xpixsize,
          debug=False, hdu=None, status_file=None, ypixsize=None, verbose=False):
    '''
...
def mSubset(images_table, template_header, subset_table, debug_level=None,
          fast_mode=False, status_file=None, verbose=False):
    '''
...
def mTANHdr(orig_header, new_header, debug=False, order=None, max_iter=None,
          tolerance=None, status_file=None, verbose=False):
    '''
...
def mTblSort(in_table, column_name, out_table, debug=False, verbose=False):
    '''
...
def mTileHdr(orig_header, new_header, n_x, n_y, ix, iy, debug=False,
          status_file=None, xpad=None, ypad=None, verbose=False):
    '''
